...
function getCategorySlug($categoryName)
{
    ...
    if (strpos($lower, 'pantai') !== false || strpos($lower, 'laut') !== false || strpos($lower, 'bahari') !== false)
        return 'pantai';
    ...
    if (strpos($lower, 'pura') !== false || strpos($lower, 'religi') !== false || strpos($lower, 'candi') !== false)
        return 'pura';
    if (strpos($lower, 'buatan') !== false || strpos($lower, 'taman') !== false || strpos($lower, 'rekreasi') !== false || strpos($lower, 'kebun') !== false)
        return 'buatan';
    return 'lainnya';
}
...
<body>
    ...
    <section class="hero assistant-hero"
        style="min-height: 380px; height: 45vh; padding-top: 130px; padding-bottom: 50px;">
        ...
        <div class="container hero-content text-center"
            ...
            <h1 style="font-size: 2.5rem; margin-bottom: 10px;">
                <?php echo ($current_lang === 'id') ? 'Asisten Rekomendasi' : 'Recommendation Assistant'; ?>
                <span>BaliRecom</span>
            </h1>
            <p style="max-width: 700px; margin: 0 auto; opacity: 0.9;">
                <?php echo ($current_lang === 'id') ? 'Temukan destinasi liburan impian Anda di Bali secara personal yang disesuaikan dengan minat, lokasi, dan kriteria perjalanan Anda.' : 'Find your dream holiday destination in Bali personally tailored to your interests, location, and travel criteria.'; ?>
            </p>
        </div>
    </section>

    <!-- Preference Questionnaire (Wizard Section) -->
    <section class="wizard-section container" id="kuesioner"
        style="padding-top: 40px; <?php if ($isWizardActive)
            echo 'display: none;'; ?>">
        <div class="section-header">
            <h2>
                <?php echo __('wizard_title'); ?>
            </h2>
            <p>
                <?php echo __('wizard_subtitle'); ?>
            </p>
        </div>
        ...
        <div class="wizard-container glass-card">
                ...
                <div class="progress-steps">
                    <div class="step-dot active" data-step="1">
                        ...
                        <span class="step-label">
                            <?php echo ($current_lang === 'id') ? 'Preferensi' : 'Preference'; ?>
                        </span>
                    </div>
                    <div class="step-dot" data-step="2">
                        <span class="step-num">2</span>
                        <span class="step-label">
                            <?php echo ($current_lang === 'id') ? 'Kategori' : 'Category'; ?>
                        </span>
                    </div>
                    <div class="step-dot" data-step="3">
                        <span class="step-num">3</span>
                        <span class="step-label">
                            <?php echo __('step_label_location'); ?>
                        </span>
                    </div>
                </div>
            </div>
            ...
            <form id="wizardForm" action="rekomendasi.php" method="GET">
                ...
                <div class="wizard-step active" data-step="1">
                    <div class="step-info">
                        <h3>
                            <?php echo __('step_1_title'); ?>
                        </h3>
                        <p>
                            <?php echo __('step_1_desc'); ?>
                        </p>
                    </div>
                    <div class="wizard-options-grid">
                        <label class="wizard-option-card">
                            ...
                            <div class="option-content">
                                ...
                                <h4>
                                    <?php echo __('opt_all_cat_title'); ?>
                                </h4>
                                <p>
                                    <?php echo __('opt_all_cat_desc'); ?>
                                </p>
                            </div>
                        </label>
                        <label class="wizard-option-card">
                            ...
                            <div class="option-content">
                                ...
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Pesona pantai pasir putih, taman rekreasi air, dan hiburan seru' : 'Charming white sand beaches, water parks, and exciting recreation'; ?>
                                </p>
                            </div>
                        </label>
                        <label class="wizard-option-card">
                            ...
                            <div class="option-content">
                                ...
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Keindahan air terjun, pegunungan, danau, dan hutan hijau yang asri' : 'Beauty of waterfalls, mountains, lakes, and serene green forests'; ?>
                                </p>
                            </div>
                        </label>
                        <label class="wizard-option-card">
                            ...
                            <div class="option-content">
                                ...
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Eksplorasi desa adat, pura suci kuno, seni tari, dan istana kerajaan' : 'Explore traditional villages, ancient sacred temples, dance arts, and royal palaces'; ?>
                                </p>
                            </div>
                        </label>
                        <label class="wizard-option-card">
                            ...
                            <div class="option-content">
                                ...
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Taman bermain modern, kebun binatang, agrowisata, dan rekreasi buatan' : 'Modern amusement parks, zoos, agrotourism, and man-made recreation'; ?>
                                </p>
                            </div>
                        </label>
                        <label class="wizard-option-card">
                            ...
                            <div class="option-content">
                                ...
                                <h4>
                                    <?php echo __('opt_buatan_title'); ?>
                                </h4>
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Monumen bersejarah, pusat pariwisata terpadu, dan landmark kota' : 'Historic monuments, integrated tourism hubs, and city landmarks'; ?>
                                </p>
                            </div>
                        </label>
                    </div>
                ...
                <div class="wizard-step" data-step="2">
                    <div class="step-info">
                        <h3>
                            <?php echo ($current_lang === 'id') ? 'Pilih Kategori Spesifik Wisata' : 'Select Specific Tourism Category'; ?>
                        </h3>
                        <p>
                            <?php echo ($current_lang === 'id') ? 'Sesuaikan dengan jenis objek wisata yang lebih mendetail di Bali' : 'Tailor to a more detailed type of tourist attraction in Bali'; ?>
                        </p>
                    </div>
                    <div class="wizard-options-grid">
                        ...
                        <label class="wizard-option-card" data-parent-categories="all">
                            ...
                            <div class="option-content">
                                <div class="option-icon"><i class="fa-solid fa-border-all"></i></div>
                                <h4>
                                    <?php echo ($current_lang === 'id') ? 'Semua Kategori' : 'All Categories'; ?>
                                </h4>
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Menampilkan semua jenis kategori wisata tanpa filter detail' : 'Display all types of tourism categories without detail filter'; ?>
                                </p>
                            </div>
                        </label>
                        ...
                        <label class="wizard-option-card" data-parent-categories="Wisata Rekreasi">
                            ...
                            <div class="option-content">
                                <div class="option-icon"><i class="fa-solid fa-umbrella-beach"></i></div>
                                <h4>
                                    <?php echo ($current_lang === 'id') ? 'Pantai Pasir Putih' : 'White Sand Beach'; ?>
                                </h4>
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Pesisir pasir putih, deburan ombak hangat, dan panorama laut' : 'White sandy coastline, warm waves, and ocean panoramas'; ?>
                                </p>
                            </div>
                        </label>
                        <label class="wizard-option-card" data-parent-categories="Wisata Rekreasi">
                            ...
                            <div class="option-content">
                                ...
                                <h4>
                                    <?php echo ($current_lang === 'id') ? 'Sunset Point & Beach Club' : 'Sunset Point & Beach Club'; ?>
                                </h4>
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Spot foto pemandangan senja matahari terbenam dan tempat bersantai' : 'Sunset view photo spots and beachside relaxation hubs'; ?>
                                </p>
                            </div>
                        </label>
                        <label class="wizard-option-card" data-parent-categories="Wisata Rekreasi">
                            ...
                            <div class="option-content">
                                ...
                                <h4>
                                    <?php echo ($current_lang === 'id') ? 'Snorkeling, Diving & Surfing' : 'Snorkeling, Diving & Surfing'; ?>
                                </h4>
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Olahraga air, titik selam terumbu karang, surfing, dan wisata bahari' : 'Water sports, coral reef diving spots, surfing, and marine tourism'; ?>
                                </p>
                            </div>
                        </label>
                        <label class="wizard-option-card" data-parent-categories="Wisata Rekreasi">
                            ...
                            <div class="option-content">
                                ...
                                <h4>
                                    <?php echo ($current_lang === 'id') ? 'Kuliner & Seafood' : 'Culinary & Seafood'; ?>
                                </h4>
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Makanan khas Bali, warung kuliner tradisional, dan tempat makan tepi pantai' : 'Balinese culinary specialties, traditional food stalls, and beachside restaurants'; ?>
                                </p>
                            </div>
                        </label>
                        <label class="wizard-option-card" data-parent-categories="Wisata Rekreasi">
                            ...
                            <div class="option-content">
                                ...
                                <h4>
                                    <?php echo ($current_lang === 'id') ? 'Wahana Waterpark & Rafting' : 'Waterpark & Rafting Rides'; ?>
                                </h4>
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Pusat watersport seru, rafting sungai, waterpark, dan rekreasi keluarga' : 'Exciting watersport hubs, river rafting, waterparks, and family recreation'; ?>
                                </p>
                            </div>
                        </label>
                        ...
                        <label class="wizard-option-card" data-parent-categories="Wisata Alam">
                            ...
                            <div class="option-content">
                                ...
                                <h4>
                                    <?php echo ($current_lang === 'id') ? 'Air Terjun (Waterfall)' : 'Waterfall'; ?>
                                </h4>
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Kesegaran aliran air pegunungan alami yang asri di pedalaman Bali' : 'Freshness of natural mountain waterfalls in inland Bali'; ?>
                                </p>
                            </div>
                        </label>
                        <label class="wizard-option-card" data-parent-categories="Wisata Alam">
                            ...
                            <div class="option-content">
                                ...
                                <h4>
                                    <?php echo ($current_lang === 'id') ? 'Pegunungan & Gunung Vulkanik' : 'Mountains & Volcanoes'; ?>
                                </h4>
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Jalur pendakian gunung, pemandangan kawah, dan udara segar pegunungan' : 'Mountain trekking trails, crater views, and fresh mountain air'; ?>
                                </p>
                            </div>
                        </label>
                        <label class="wizard-option-card" data-parent-categories="Wisata Alam">
                            ...
                            <div class="option-content">
                                ...
                                <h4>
                                    <?php echo ($current_lang === 'id') ? 'Perbukitan & Camping' : 'Hills & Camping'; ?>
                                </h4>
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Lembah hijau yang berangin, perbukitan sabana, dan tempat berkemah' : 'Breezy green valleys, savanna hills, and camping grounds'; ?>
                                </p>
                            </div>
                        </label>
                        <label class="wizard-option-card" data-parent-categories="Wisata Alam">
                            ...
                            <div class="option-content">
                                <div class="option-icon"><i class="fa-solid fa-water"></i></div>
                                <h4>
                                    <?php echo ($current_lang === 'id') ? 'Danau Pegunungan' : 'Mountain Lakes'; ?>
                                </h4>
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Keindahan danau vulkanik yang sejuk dan tenang di daerah dataran tinggi' : 'Beauty of cool and serene volcanic lakes in highland areas'; ?>
                                </p>
                            </div>
                        </label>
                        <label class="wizard-option-card" data-parent-categories="Wisata Alam">
                            ...
                            <div class="option-content">
                                ...
                                <h4>
                                    <?php echo ($current_lang === 'id') ? 'Hutan Lindung & Mangrove' : 'Protected Forest & Mangrove'; ?>
                                </h4>
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Hutan pala kuno yang dihuni kera, hutan mangrove pesisir, dan alam liar' : 'Ancient monkey forests, coastal mangroves, and pristine wilderness'; ?>
                                </p>
                            </div>
                        </label>
                        <label class="wizard-option-card" data-parent-categories="Wisata Alam">
                            ...
                            <div class="option-content">
                                ...
                                <h4>
                                    <?php echo ($current_lang === 'id') ? 'Pemandian Air Panas Alami' : 'Natural Hot Springs'; ?>
                                </h4>
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Kolam air hangat alami kaya mineral belerang di kaki gunung' : 'Natural warm pool rich in sulfur minerals at the foot of mountain'; ?>
                                </p>
                            </div>
                        </label>
                        <label class="wizard-option-card" data-parent-categories="Wisata Alam">
                            ...
                            <div class="option-content">
                                ...
                                <h4>
                                    <?php echo ($current_lang === 'id') ? 'Sawah Terasering & Subak' : 'Rice Terraces & Subak'; ?>
                                </h4>
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Hamparan persawahan berundak khas Bali dengan sistem irigasi subak' : 'Layered Balinese terraced rice fields with traditional subak irrigation'; ?>
                                </p>
                            </div>
                        </label>
                        ...
                        <label class="wizard-option-card" data-parent-categories="Wisata Budaya">
                            ...
                            <div class="option-content">
                                ...
                                <h4>
                                    <?php echo ($current_lang === 'id') ? 'Pura Suci & Religi' : 'Sacred Temple & Religious'; ?>
                                </h4>
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Kompleks pura Hindu bersejarah dengan arsitektur klasik Bali kuno' : 'Historic Hindu temple complexes with ancient classic Balinese architecture'; ?>
                                </p>
                            </div>
                        </label>
                        <label class="wizard-option-card" data-parent-categories="Wisata Budaya">
                            ...
                            <div class="option-content">
                                <div class="option-icon"><i class="fa-solid fa-masks-theater"></i></div>
                                <h4>
                                    <?php echo ($current_lang === 'id') ? 'Pertunjukan Seni & Tari' : 'Art Performances & Dance'; ?>
                                </h4>
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Pertunjukan Tari Kecak, Barong, Legong, dan atraksi kebudayaan' : 'Kecak dance, Barong, Legong performances, and cultural attractions'; ?>
                                </p>
                            </div>
                        </label>
                        <label class="wizard-option-card" data-parent-categories="Wisata Budaya">
                            ...
                            <div class="option-content">
                                ...
                                <h4>
                                    <?php echo ($current_lang === 'id') ? 'Museum & Galeri Seni' : 'Museums & Art Galleries'; ?>
                                </h4>
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Galeri lukisan legendaris, pameran seni rupa, dan warisan sejarah' : 'Legendary painting galleries, art exhibitions, and historical heritage'; ?>
                                </p>
                            </div>
                        </label>
                        <label class="wizard-option-card" data-parent-categories="Wisata Budaya">
                            ...
                            <div class="option-content">
                                ...
                                <h4>
                                    <?php echo ($current_lang === 'id') ? 'Desa Adat & Kerajinan' : 'Traditional & Craft Village'; ?>
                                </h4>
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Kehidupan pedesaan asri Bali yang kaya adat istiadat dan pasar seni' : 'Serene rural life of Bali rich in traditional custom and art markets'; ?>
                                </p>
                            </div>
                        </label>
                        <label class="wizard-option-card" data-parent-categories="Wisata Budaya">
                            ...
                            <div class="option-content">
                                ...
                                <h4>
                                    <?php echo ($current_lang === 'id') ? 'Istana & Puri Kerajaan' : 'Royal Palaces'; ?>
                                </h4>
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Kompleks kediaman raja-raja Bali masa lampau yang bersejarah' : 'Historical residence complexes of Balinese kings from the past'; ?>
                                </p>
                            </div>
                        </label>
                        ...
                        <label class="wizard-option-card" data-parent-categories="Wisata Buatan">
                            ...
                            <div class="option-content">
                                ...
                                <h4>
                                    <?php echo ($current_lang === 'id') ? 'Agrowisata & Kebun Kopi' : 'Agrotourism & Coffee Plantation'; ?>
                                </h4>
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Perkebunan kopi Luwak, kebun buah-buahan, dan edukasi pertanian' : 'Luwak coffee plantations, fruit orchards, and agricultural tours'; ?>
                                </p>
                            </div>
                        </label>
                        <label class="wizard-option-card" data-parent-categories="Wisata Buatan">
                            ...
                            <div class="option-content">
                                ...
                                <h4>
                                    <?php echo ($current_lang === 'id') ? 'Taman Bunga & Kebun Raya' : 'Flower Gardens & Botanic Gardens'; ?>
                                </h4>
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Taman bunga asri, kebun raya botani, dan kawasan hijau terbuka' : 'Beautiful flower gardens, botanical gardens, and open green areas'; ?>
                                </p>
                            </div>
                        </label>
                        <label class="wizard-option-card" data-parent-categories="Wisata Buatan">
                            ...
                            <div class="option-content">
                                ...
                                <h4>
                                    <?php echo ($current_lang === 'id') ? 'Taman Safari & Satwa' : 'Safari Parks & Wildlife'; ?>
                                </h4>
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Konservasi satwa liar khas, kebun binatang edukatif, dan taman burung' : 'Conservation of exotic wildlife, educational zoos, and bird parks'; ?>
                                </p>
                            </div>
                        </label>
                        <label class="wizard-option-card" data-parent-categories="Wisata Buatan">
                            ...
                            <div class="option-content">
                                ...
                                <h4>
                                    <?php echo ($current_lang === 'id') ? 'Spot Rekreasi Buatan' : 'Man-made Attractions'; ?>
                                </h4>
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Spot foto kreatif, agrowisata modern, dan tempat bermain buatan' : 'Creative photo spots, modern agrotourism, and themed play areas'; ?>
                                </p>
                            </div>
                        </label>
                        ...
                        <label class="wizard-option-card" data-parent-categories="Wisata Umum">
                            ...
                            <div class="option-content">
                                <div class="option-icon"><i class="fa-solid fa-city"></i></div>
                                <h4>
                                    <?php echo ($current_lang === 'id') ? 'Pusat Wisata & Landmark' : 'Tourism Hubs & Landmarks'; ?>
                                </h4>
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Kawasan pariwisata terpadu, monumen ikonik kota, dan jalanan ramai' : 'Integrated tourist areas, iconic city monuments, and popular streets'; ?>
                                </p>
                            </div>
                        </label>
                        <label class="wizard-option-card" data-parent-categories="Wisata Umum">
                            ...
                            <div class="option-content">
                                ...
                                <h4>
                                    <?php echo ($current_lang === 'id') ? 'Jembatan Ikonik' : 'Iconic Bridges'; ?>
                                </h4>
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Karya jembatan dengan pemandangan lanskap alam atau laut Bali' : 'Architectural bridge works with views of Balinese nature or ocean'; ?>
                                </p>
                            </div>
                        </label>
                        <label class="wizard-option-card" data-parent-categories="Wisata Umum">
                            ...
                            <div class="option-content">
                                <div class="option-icon"><i class="fa-solid fa-water"></i></div>
                                <h4>
                                    <?php echo ($current_lang === 'id') ? 'Bendungan Air' : 'Water Dams'; ?>
                                </h4>
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Danau bendungan buatan dengan pemandangan pegunungan dan udara segar' : 'Man-made dam lakes with mountain views and fresh breeze'; ?>
                                </p>
                            </div>
                        </label>
                    </div>
                ...
                <div class="wizard-step" data-step="3">
                    <div class="step-info">
                        <h3>
                            <?php echo __('step_location_title'); ?>
                        </h3>
                        <p>
                            <?php echo __('step_location_desc'); ?>
                        </p>
                    </div>
                    <div class="wizard-options-grid location-options-grid">
                        <label class="wizard-option-card">
                            ...
                            <div class="option-content">
                                ...
                                <h4>
                                    <?php echo ($current_lang === 'id') ? 'Semua Wilayah' : 'All Regions'; ?>
                                </h4>
                                <p>
                                    <?php echo ($current_lang === 'id') ? 'Tampilkan rekomendasi dari seluruh kabupaten di Bali' : 'Show recommendations from all regencies in Bali'; ?>
                                </p>
                            </div>
                        </label>
                        <?php foreach ($locations as $loc): ?>
                            <label class="wizard-option-card">
                                ...
                                <div class="option-content">
                                    ...
                                    <p>
                                        <?php echo ($current_lang === 'id') ? 'Hanya tampilkan destinasi di ' . htmlspecialchars($loc) : 'Only show destinations in ' . htmlspecialchars($loc); ?>
                                    </p>
                                </div>
                            </label>
                        <?php endforeach; ?>
    ...
    <?php if ($isWizardActive): ?>
        ...
        <section class="results-section container reveal-on-scroll" id="hasil" style="padding-top: 40px;">
            <div class="preference-summary-card glass-card"
                style="margin-bottom: 40px; padding: 25px; border-radius: var(--radius-lg); border: 1px solid var(--glass-border); display: flex; flex-wrap: wrap; justify-content: space-between; align-items: center; gap: 20px;">
                <div style="flex: 1; min-width: 280px;">
                    <h3
                        style="font-size: 1.3rem; margin-bottom: 8px; font-family: var(--font-primary); color: var(--text);">
                        <i class="fa-solid fa-circle-info" style="color: var(--primary);"></i>
                        <?php echo __('results_title'); ?>
                    </h3>
                    <div class="pref-badges-row" style="display: flex; flex-wrap: wrap; gap: 10px;">
                        <span class="badge"
                            style="background: rgba(var(--primary-rgb), 0.15); color: var(--primary); padding: 6px 12px; border-radius: 20px; font-size: 0.85rem; font-weight: 500;">
                            <i class="fa-solid fa-tags"></i>
                            <?php echo ($current_lang === 'id') ? 'Preferensi' : 'Preference'; ?>:
                            <?php echo htmlspecialchars($pref_category === 'all' ? (($current_lang === 'id') ? 'Semua' : 'All') : $pref_category); ?>
                        </span>
                        <span class="badge"
                            style="background: rgba(var(--primary-rgb), 0.15); color: var(--primary); padding: 6px 12px; border-radius: 20px; font-size: 0.85rem; font-weight: 500;">
                            <i class="fa-solid fa-filter"></i>
                            <?php echo ($current_lang === 'id') ? 'Kategori' : 'Category'; ?>:
                            <?php echo htmlspecialchars($pref_subcategory === 'all' ? (($current_lang === 'id') ? 'Semua' : 'All') : $pref_subcategory); ?>
                        </span>
                        <span class="badge"
                            style="background: rgba(var(--primary-rgb), 0.15); color: var(--primary); padding: 6px 12px; border-radius: 20px; font-size: 0.85rem; font-weight: 500;">
                            <i class="fa-solid fa-location-dot"></i>
                            <?php echo __('results_loc'); ?>:
                            <?php echo htmlspecialchars($pref_location === 'all' ? (($current_lang === 'id') ? 'Semua Wilayah' : 'All Regions') : $pref_location); ?>
                        </span>
                    </div>
                </div>
                <a href="rekomendasi.php" class="btn btn-outline"
                    style="white-space: nowrap; display: inline-flex; align-items: center; gap: 8px;">
                    <i class="fa-solid fa-rotate-left"></i>
                    <?php echo __('btn_repeat'); ?>
                </a>
            </div>
            ...
            <div class="section-header flex-header" style="margin-bottom: 30px;">
                <div>
                    <h2>
                        <?php echo __('results_header'); ?> <i class="fa-solid fa-sparkles"
                ...
                <div class="sort-by">
                    <span>
                        <?php echo __('sort_label'); ?>
                    </span>
                    <select class="sort-select" id="sortFilter"
                        data-baseurl="<?php echo getFilterUrl(['sort' => null, 'user_lat' => null, 'user_lng' => null]); ?>">
                        <option value="relevan" <?php if ($sort === 'relevan')
                            echo 'selected'; ?>>
                            <?php echo __('sort_relevance'); ?>
                        </option>
                        <option value="rating" <?php if ($sort === 'rating')
                            echo 'selected'; ?>>
                            <?php echo __('sort_rating'); ?>
                        </option>
                        <option value="nama" <?php if ($sort === 'nama')
                            echo 'selected'; ?>>
                            <?php echo __('sort_name'); ?>
                        </option>
                        <option value="jarak" <?php if ($sort === 'jarak')
                            echo 'selected'; ?>>
                            <?php echo ($current_lang === 'id') ? '🎯 Jarak Terdekat' : '🎯 Nearest Proximity'; ?>
                        </option>
                    </select>
                </div>
            </div>
            ...
            <div class="destination-grid" id="destinationGrid">
                <?php if (empty($displayedPlaces)): ?>
                    <div class="error-state">
                        ...
                        <h3>
                            <?php echo ($current_lang === 'id') ? 'Destinasi Tidak Ditemukan' : 'Destinations Not Found'; ?>
                        </h3>
                        <p>
                            <?php echo ($current_lang === 'id') ? 'Coba sesuaikan pilihan kuesioner Anda untuk hasil yang lebih luas.' : 'Try adjusting your questionnaire choices for broader results.'; ?>
                        </p>
                    </div>
                <?php else: ?>
                    <?php foreach ($displayedPlaces as $place): ?>
                        ...
                        <div class="dest-card" data-category="<?php echo $slug; ?>">
                            <div class="dest-img-wrap">
                                <img src="<?php echo $imgSrc; ?>" alt="<?php echo htmlspecialchars($nama); ?>" class="dest-img"
                                    loading="lazy">
                                <div class="dest-badge">
                                    <?php echo htmlspecialchars(getCategoryTranslated($kategori, $current_lang)); ?>
                                </div>
                            </div>
                            <div class="dest-content">
                                <div class="dest-meta">
                                    ...
                                    <span class="location"><i class="fa-solid fa-location-dot"></i>
                                        <?php echo htmlspecialchars(getLocationTranslated($lokasiVal, $current_lang)); ?>
                                    </span>
                                    <?php if (isset($place['distance'])): ?>
                                        <span class="distance" style="color:var(--primary); font-weight:600;"><i
                                                class="fa-solid fa-location-arrow"></i>
                                            <?php echo number_format($place['distance'], 1); ?> km
                                        </span>
                                    <?php endif; ?>
                                </div>
                                <h3>
                                ...
                                <p>
                                    <?php echo htmlspecialchars(getTranslatedDescription($deskripsiVal, $nama, $kategori, $lokasiVal, $current_lang)); ?>
                                </p>

                                <div class="dest-footer">
                                    <button class="btn btn-outline btn-sm view-detail-btn"
                                        data-place="<?php echo $placeDataJson; ?>"><i class="fa-solid fa-circle-info"></i>
                                        <?php echo __('btn_detail'); ?>
                                    </button>
                                    <a href="destinasi.php?action=similar&similar_to=<?php echo urlencode($nama); ?>#destinasi"
                                        class="btn btn-primary btn-sm btn-recom similar-btn"><i
            ...
            <?php if (isset($totalPages) && $totalPages > 1): ?>
                <div class="pagination-container">
                    <div class="pagination">
                        ...
                        <?php if ($page > 1): ?>
                            <a href="<?php echo getFilterUrl(['page' => $page - 1]); ?>#hasil" class="page-link prev-page"
                                title="Previous Page">
                        ...
                        <?php if ($page < $totalPages): ?>
                            <a href="<?php echo getFilterUrl(['page' => $page + 1]); ?>#hasil" class="page-link next-page"
                                title="Next Page">
        ...
        <section class="map-section container reveal-on-scroll" id="peta" style="padding-top: 40px; margin-bottom: 60px;">
            <div class="section-header">
                <h2>
                    <?php echo ($current_lang === 'id') ? 'Peta Lokasi Rekomendasi' : 'Recommended Locations Map'; ?>
                </h2>
                <p>
                    <?php echo ($current_lang === 'id') ? 'Distribusi spasial objek wisata yang paling relevan dengan pilihan liburan Anda.' : 'Spatial distribution of tourist attractions that are most relevant to your holiday choices.'; ?>
                </p>
            </div>
