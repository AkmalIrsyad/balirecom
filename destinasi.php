...
function getCategorySlug($cat)
{
    ...
    if (strpos($cat, 'pantai') !== false || strpos($cat, 'rekreasi') !== false)
        return 'rekreasi';
    if (strpos($cat, 'alam') !== false || strpos($cat, 'air terjun') !== false || strpos($cat, 'gunung') !== false || strpos($cat, 'danau') !== false)
        return 'alam';
    if (strpos($cat, 'budaya') !== false || strpos($cat, 'desa') !== false || strpos($cat, 'sejarah') !== false)
        return 'budaya';
    if (strpos($cat, 'pura') !== false || strpos($cat, 'religi') !== false || strpos($cat, 'candi') !== false)
        return 'pura';
    if (strpos($cat, 'taman') !== false || strpos($cat, 'buatan') !== false || strpos($cat, 'umum') !== false)
        return 'umum';
    return 'umum';
}
...
<head>
    ...
    <title>
        <?php echo __('nav_destinations'); ?> - BaliRecom
    </title>
...
<body class="destinasi-page">
    ...
    <nav class="navbar glass">
        <div class="container nav-container">
            ...
            <div class="nav-links">
                ...
                <a href="destinasi.php" class="active">
    ...
    <section class="hero" style="min-height: 460px; padding: 120px 0 80px 0; position: relative; z-index: 100;">
        <div class="hero-slideshow">
            <div class="hero-slide active"
                style="background-image: url('https://images.unsplash.com/photo-1518548419970-58e3b4079ab2?auto=format&fit=crop&w=1920&q=85');">
            </div>
        </div>
        <div class="hero-overlay"></div>
        <div class="container hero-content" style="position: relative; z-index: 100;">
            <h1>
                <?php echo ($current_lang === 'id') ? 'Destinasi Wisata' : 'Tourist Destinations'; ?> <span>Bali</span>
            </h1>
            <p>
                <?php echo ($current_lang === 'id') ? 'Temukan pesona tersembunyi dan keindahan alam di setiap sudut Pulau Dewata.' : 'Discover hidden gems and natural beauty in every corner of the Island of Gods.'; ?>
            </p>

            <!-- Hero Search & Filter Card -->
            <form action="destinasi.php#destinasi" method="GET" class="hero-search-card"
                ...
                <div class="hero-search-row-bottom">
                    ...
                    <div class="custom-dropdown-wrap" id="dropdownLocation">
                        <input type="hidden" name="location" id="inputLocation"
                        ...
                        <div class="custom-dropdown-menu">
                            <div class="dropdown-item <?php if ($location === 'all' || empty($location))
                                echo 'active'; ?>" data-value="all">
                                <span>
                            ...
                            <?php foreach ($locations as $loc): ?>
                                <div class="dropdown-item <?php if ($location === $loc)
                                    echo 'active'; ?>" data-value="<?php echo htmlspecialchars($loc); ?>">
                                    <span>
                    ...
                    <div class="custom-dropdown-wrap" id="dropdownCategory">
                        ...
                        <button type="button" class="custom-dropdown-trigger">
                            ...
                            <span class="trigger-label">
                                <?php echo htmlspecialchars($currentCatLabel); ?>
                            </span>
                            <i class="fa-solid fa-chevron-down arrow-icon"></i>
                        </button>
                        <div class="custom-dropdown-menu">
                            <?php foreach ($catLabels as $val => $lbl): ?>
                                <div class="dropdown-item <?php if ($category === $val)
                                    echo 'active'; ?>" data-value="<?php echo $val; ?>">
                                    <span>
                    ...
                    <div class="custom-dropdown-wrap" id="dropdownRating">
                        ...
                        <button type="button" class="custom-dropdown-trigger">
                            ...
                            <span class="trigger-label">
                                <?php echo htmlspecialchars($currentRatingLabel); ?>
                            </span>
                            <i class="fa-solid fa-chevron-down arrow-icon"></i>
                        </button>
                        <div class="custom-dropdown-menu">
                            <?php foreach ($ratingLabels as $val => $lbl): ?>
                                <div class="dropdown-item <?php if ($rating === $val)
                                    echo 'active'; ?>" data-value="<?php echo htmlspecialchars($val); ?>">
                                    <span>
                                        <?php echo htmlspecialchars($lbl); ?>
                                    </span>
                                    <i class="fa-solid fa-check check-icon"></i>
    ...
    <section class="stats-overview-section container reveal-on-scroll"
        ...
        <div class="stats-grid-card">
            <div class="stat-item">
                ...
                <div class="stat-label">
                    <?php echo ($current_lang === 'id') ? 'Total Destinasi Wisata' : 'Total Tourist Attractions'; ?>
                </div>
            </div>
            <div class="stat-item">
                ...
                <div class="stat-label">
                    <?php echo ($current_lang === 'id') ? 'Kabupaten & Kota Bali' : 'Regencies in Bali'; ?>
                </div>
            </div>
            <div class="stat-item">
                ...
                <div class="stat-label">
                    <?php echo ($current_lang === 'id') ? 'Rating Rata-rata Wisata' : 'Average Attraction Rating'; ?>
                </div>
            </div>
            <div class="stat-item">
                ...
                <div class="stat-label">
                    <?php echo ($current_lang === 'id') ? 'Kategori & Subkategori' : 'Categories & Subcategories'; ?>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="destinations container reveal-on-scroll" id="destinasi" style="padding-top: 50px;">
        <div class="section-header flex-header">
            <div>
                <h2>
                    <?php echo $resultHeaderTitle; ?>
                </h2>
                <p>
                    <?php echo $resultHeaderDesc; ?>
                </p>
                <?php if ($action === 'similar'): ?>
                    <div style="margin-top: 12px;">
                        <a href="destinasi.php#destinasi" class="btn btn-outline btn-sm"
                            style="font-size: 0.82rem; padding: 6px 14px; border-radius: 20px;">
                            <i class="fa-solid fa-rotate-left"></i>
                            <?php echo ($current_lang === 'id') ? 'Tampilkan Semua Destinasi' : 'Show All Destinations'; ?>
                        </a>
                    </div>
                <?php endif; ?>
            </div>
            <div class="sort-by">
                ...
                <select class="sort-select" id="sortFilter"
                    data-baseurl="<?php echo getFilterUrl(['sort' => null]); ?>">
                    <option value="" <?php if (empty($sort))
                        echo 'selected'; ?>>
                        <?php echo ($current_lang === 'id') ? 'Default' : 'Default'; ?>
                    </option>
        ...
        <div class="destination-grid" id="destinationGrid">
            <?php if (empty($displayedPlaces)): ?>
                <div class="error-state">
                    ...
                    <p>
                        <?php echo ($current_lang === 'id') ? 'Coba sesuaikan kata kunci pencarian atau filter kategori Anda.' : 'Try adjusting your search keywords or category filters.'; ?>
                    </p>
                </div>
            <?php else: ?>
        ...
        <?php if ($totalPages > 1): ?>
            <div class="pagination-container">
                <div class="pagination">
                    ...
                    <?php if ($page > 1): ?>
                        <a href="<?php echo getFilterUrl(['page' => $page - 1]); ?>#destinasi" class="page-link prev-page"
                            title="Previous Page">
                    ...
                    <?php if ($page < $totalPages): ?>
                        <a href="<?php echo getFilterUrl(['page' => $page + 1]); ?>#destinasi" class="page-link next-page"
                            title="Next Page">
    ...
    <footer class="footer">
        ...
        <div class="footer-bottom">
            <div class="container">
                <p>&copy;
                    <?php echo date('Y'); ?> BaliRecom. All rights reserved.
                </p>
            </div>
        </div>
    </footer>
